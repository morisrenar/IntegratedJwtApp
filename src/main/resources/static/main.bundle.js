...
var DirectorsCenterComponent = (function () {
    function DirectorsCenterComponent(directorsService) {
        ...
        this.isEmbedded = true;
        this.directors = [];
        this.facility = JSON.parse(localStorage.getItem('currentFacility'));
        if (this.isEmbedded == true) {
            this.directors = [];
        }
        else {
    ...
    DirectorsCenterComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (this.isEmbedded == true) {
            this.directorsService.getDirectors(this.facility).subscribe(function (resDirectors) { return _this.directors = resDirectors; });
        }
    };
    ...
    DirectorsCenterComponent.prototype.onUpdateDirectorsEvent = function (directors) {
        var _this = this;
        if (this.isEmbedded == true) {
            this.directorsService.updateDirectors(this.facility, directors).subscribe(function (resDirectors) { return _this.directors = resDirectors; });
        }
    };
...
DirectorsCenterComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__service_directors_service__["a" /* DirectorsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__service_directors_service__["a" /* DirectorsService */]) === "function" && _a || Object])
...
var DirectorsService = (function () {
    ...
    DirectorsService.prototype.createDirectors = function (facility, directors) {
    ...
    DirectorsService.prototype.getDirectors = function (facility) {
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: this.headers });
        return this._http.get(this._getUrl + "/" + facility.facilitiesId + "/directors", options)
            .map(function (response) { return response.json(); });
    };
    DirectorsService.prototype.updateDirectors = function (facility, directors) {
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: this.headers });
    ...
    DirectorsService.prototype.deleteDirectors = function (facility, directors) {
